...
const App = new Vue({
  ...
  data: {
    ...
    userId: '',
    /* goEasy 添加以下变量 */
    channel: '2469526177317088', // GoEasy channel
    appkey: 'BC-beb8090003fd4e3586bc6485be3f4c54', // GoEasy应用appkey，替换成你的appkey

    /* leancloud-realtime 添加以下变量，appId、appKey、server这几个值去leancloud控制台>设置>应用凭证里面找 */
    chatRoom: '639c6332ee7d8714c03ab160',
    appId: 'upvWqMxfUGOXu6RP8pLHszVK-gzGzoHsz',
    appKey: 'Hxwv6DQOY9PC2pc21hkEmoHV',
    server: 'https://upvwqmxf.lc-cn-n1-shared.com', // REST API 服务器地址
  },
  methods: {
    randomString(length) {
      let str = ''
